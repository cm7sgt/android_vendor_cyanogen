...
# Euro Tab
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=GT-P1000 BUILD_ID=GINGERBREAD BUILD_DISPLAY_ID=GINGERBREAD.XXJQ1 BUILD_FINGERPRINT=samsung/GT-P1000/GT-P1000:2.3.3/GINGERBREAD/XXJQ1:user/release-keys PRIVATE_BUILD_DESC="GT-P1000-user 2.3.3 GINGERBREAD XXJQ1 release-keys"
